...
using Microsoft.ConferenceBuddy.Common.Extensions;
using Newtonsoft.Json;

namespace Microsoft.ConferenceBuddy.Common.Utilities
{
    /// <summary>
    /// Helper utility class for Http client
    /// </summary>
    public static class HttpClientUtility
    {
        public static readonly int RETRY_COUNT = 2;
        public static readonly int RETRY_DELAY = 50;
